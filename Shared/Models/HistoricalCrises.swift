    ...
    static func eisenhowerCrises() -> [HistoricalCrisis] {
        return [
            ...
            HistoricalCrisis(
                ...
                year: 1959,
                description: "Khrushchev wants a full tour of America. Security concerns. He's volatile - humiliating him risks nuclear incident. Camp David talks scheduled.",
                countries: ["USSR"],
                options: [
                    HistoricalCrisisOption(title: "Allow full tour including Hollywood", outcome: "Khrushchev pleased. Brief thaw in relations."),
