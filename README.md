...
```bash
# Install from DMG
open GTNW-latest.dmg

# Or from source
cd "/Volumes/Data/xcode/GTNW"
xcodebuild -project "GTNW.xcodeproj" -scheme "GTNW" -configuration Release build
...
### App Support:
- GitHub Issues: [Report bugs](https://github.com/kochj23/GTNW/issues)
...
**GTNW - Powerful AI with responsible safeguards**
